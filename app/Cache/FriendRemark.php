...
class FriendRemark extends HashRedis
{
     ...
     */
    public function save(string $user_id, int $friend_id, string $remark)
    {
     ...
     * @return string
     */
    public function read(string $user_id, int $friend_id): string
    {
     ...
     * @return string
     */
    private function _flag(string $user_id, int $friend_id): string
    {
