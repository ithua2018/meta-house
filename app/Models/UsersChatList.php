...
class UsersChatList extends BaseModel
{
     ...
     * @return array
     */
    public static function addItem(string $user_id, string $receive_id, int $type)
    {
     ...
     * @return bool
     */
    public static function topItem(string $user_id, int $list_id, $is_top = true)
    {
