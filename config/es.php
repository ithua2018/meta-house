<?php
$areas_index = json_decode(file_get_contents(storage_path().'/temp/elasticsearch-index/area_mapping.json'), true);
    ...
    */
    'connections' => [
        'default' => [
            'servers' => [
                [
                    'host' => env('ELASTIC_HOST', '112.74.63.93'),
